...
enum class IntKey(
    ...
    ApsWaveMaxMinutesOfBasalToLimitSmb(R.string.key_wave_smb_max_minutes, 60, 15, 240, defaultedBySM = true, dependency = BooleanKey.ApsWaveEnable, negativeDependency = BooleanKey.ApsWaveUseSMBCap),
    ApsWaveStartTime(R.string.key_wave_start, 11, 0, 23, defaultedBySM = true, dependency = BooleanKey.ApsWaveEnable),
    ApsWaveEndTime(R.string.key_wave_end, 21, 0, 23, defaultedBySM = true, dependency = BooleanKey.ApsWaveEnable),
