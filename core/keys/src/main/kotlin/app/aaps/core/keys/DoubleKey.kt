...
enum class DoubleKey(
    ...
    ApsWaveInsReqPct(R.string.key_wave_insulinReqPCT, 65.0, 30.0, 100.0, defaultedBySM = true, dependency = BooleanKey.ApsWaveEnable),
    ApsWaveSmbCap(R.string.key_wave_smbcap, 0.5, 0.0, 5.0, defaultedBySM = true, dependency = BooleanKey.ApsWaveUseSMBCap),
