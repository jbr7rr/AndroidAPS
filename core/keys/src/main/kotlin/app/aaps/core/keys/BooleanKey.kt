...
enum class BooleanKey(
    ...
    ApsWaveUseSMBCap(R.string.key_wave_use_smbcap, false, defaultedBySM = true, dependency = ApsWaveEnable),
    ApsWaveUseAdjustedSens(R.string.key_wave_use_adjusted_sens, false, defaultedBySM = true, dependency = ApsWaveEnable),
