...
import app.aaps.plugins.aps.wavez.DetermineBasalAdapterWaveZ
...
abstract class AlgModule {
    ...
    @ContributesAndroidInjector abstract fun determineBasalAdapterWaveZInjector(): DetermineBasalAdapterWaveZ
}