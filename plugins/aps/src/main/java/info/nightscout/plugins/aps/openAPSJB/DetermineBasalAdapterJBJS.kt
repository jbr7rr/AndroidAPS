...
class DetermineBasalAdapterJBJS internal constructor(private val scriptReader: ScriptReader, private val injector: HasAndroidInjector) : DetermineBasalAdapter {
    ...
    override fun setData(
        ...
        */
        ...
        // TODO: Fix percentage (it is always 100%)
        ...
        this.profile.put("maxWaveSMBBasalMinutes", sp.getInt(R.string.key_wave_smb_max_minutes, SMBDefaults.maxUAMSMBBasalMinutes))
